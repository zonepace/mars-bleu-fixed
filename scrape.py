...
BADGE_REWARDS = [
    ...
    (
        "Roi du Canapé 🛋️",
        "Reine du Canapé 🛋️",
        "Tu as lâché la télécommande. Ta copine n’en revient pas.",
        "Tu cours. Ton soutien-gorge de sport tient. C’est déjà une victoire.",
    ),
    # 20 km
    (
        "Trotteur Prudent 🐢",
        "Trotteuse Prudente 🐢",
        "20 km. Tu as déjà créé un segment Strava et posté une story.",
        "20 km avec une queue-de-cheval qui rebondit. Un type en vélo t’a doublée. Tu l’as rattrapé.",
    ),
    # 40 km
    (
        "Joggeur du Dimanche 🚶",
        "Joggeuse du Dimanche 🚶",
        "Tu cours. Ta famille ne te croit pas, mais ton GPS si.",
        "40 km. Un inconnu t’a dit ‘bravo mademoiselle !’ avec un air surpris. Tu n’as rien dit. Tu as continué.",
    ),
    # 60 km
    (
        "Mollets en Devenir 🦵",
    ...
    (
        ...
        "Tu as dépensé plus en running qu’en maquillage ce mois-ci. La sueur, c’est un soin.",
    ),
    # 100 km
    (
        "Boule d’Acier 🍑",
    ...
    (
        "Brûleur de Semelles 🔥",
        "Brûleuse de Semelles 🔥",
        "Le vent sent la concurrence. Tu lui fais signe.",
        "Le vent t’a décoiffée. Tu as replacé ta queue-de-cheval en 0,3 secondes et continué.",
    ),
    # 160 km
    (
    ...
    (
        ...
        "Exploratrice du Macadam 🌍",
        "200 km. Tu aurais pu aller jusqu’en Belgique. Tu aurais pris des photos de chaque km.",
        "200 km avec des semelles qui frottent, un cycle qui dérègle tout et personne qui te plaint. Respect total.",
    ),
    # 220 km
    (
        "Alien du Sport 👽",
        "Alien du Sport 👽",
        "Tes collègues se demandent si tu dors ou si tu cours. Tu leur as expliqué 12 fois.",
        "Tes collègues te demandent si tu ‘fais encore du sport’. Oui. 220 km. Mais merci pour la question.",
    ),
    # 240 km
    (
        "Marathonien Autoproclamé 🏛️",
        "Marathonienne Autoproclamée 🏛️",
    ...
    (
        ...
        "Conquérante des Ronds-Points 🛤️",
        "Tu connais chaque craquelure du bitume. Et les rues où même ta Garmin te dit : « Bonne chance, JPP, je te laisse gérer frèro. »",
        "Tu connais chaque craquelure du bitume. Et les rues où même ta Garmin te dit : « Bonne chance, JPP, je te laisse gérer meuf. »",
    ),
    # 280 km
    (
        "Avaleur de Bornes 🎯",
    ...
    (
        ...
        "Météo France t’a classée ‘perturbation localisée’. Tu courrais sous la pluie, personne n’a rien dit.",
    ),
    # 320 km
    (
        "Chameau Turbo 🏜️",
    ...
    (
        "GPS Dépassé 🦾",
        "GPS Dépassé 🦾",
        "Le GPS a rendu les armes. Il ne comprend plus tes ambitions.",
        "Le GPS a rendu les armes. Toi tu sais où tu vas depuis le début. C’était pas lui le problème.",
    ),
    # 420 km
    (
        "Prophète de la Foulée 📜",
        "Prophétesse de la Foulée 📜",
    ...
    (
        ...
        "Tu cours à 5h du mat parce que c’est le seul moment à toi. Les étoiles, elles, sont là. Elles savent.",
    ),
    # 480 km
    (
    ...
    (
        ...
        "Titanide des Kilomètres 🗿",
        "Les montagnes s’écartent. Les collines font une haie d’honneur. T’as filmé.",
        "Les montagnes s’écartent. Un homme t’a dépassée au km 1. Tu l’as repris au km 3. Il n’a plus dit un mot.",
    ),
    # 540 km
    (
        "Dompteur d’Horizons 🌅",
        "Dompteuse d’Horizons 🌅",
        "L’horizon recule. Il a peur de tes stats de vitesse.",
        "L’horizon recule. Il avait entendu parler de toi via une copine qui t’avait vue doubler des gars en côte.",
    ),
    # 560 km
    (
        "Phénix de l’Asphalte 🔥🦅",
        "Phénix de l’Asphalte 🔥🦅",
        "Tu renais à chaque km. Et tu envoies un résumé hebdomadaire à tes abonnés.",
        "Tu renais à chaque km. Même quand le soutien-gorge de sport frotte, que t’as mal au ventre et que t’as pas dormi.",
    ),
    # 580 km
    (
        "Demi-Dieu en Approche 👑",
        "Demi-Déesse en Approche 👑",
        "Zeus a commandé tes chaussures. Il a aussi créé un compte Strava.",
        "Héra a commandé tes chaussures. Elle t’a regardée courir. Elle a demandé des conseils. Elle commence lundi.",
    ),
    # === TIER LÉGENDAIRE (600 km+) ===
    # 600 km
    (
        "⭐ LÉGENDAIRE ⭐ Seigneur des Foulées 🐉",
        "⭐ LÉGENDAIRE ⭐ Dame des Foulées 🐉",
    ...
    (
        ...
        "⭐ LÉGENDAIRE ⭐ Arpenteuse des Galaxies 🪐",
        "Pluton t’a envoyé un message. Tu l’as vu mais pas encore répondu — t’étais en sortie.",
        "Pluton t’a envoyé un message. Tu courrais. Il a attendu. Il attendra encore.",
    ),
    # 640 km
    (
        "⭐ LÉGENDAIRE ⭐ Requin du Bitume 🦈",
        "⭐ LÉGENDAIRE ⭐ Requin du Bitume 🦈",
        "La route disparaît sous tes pieds. Tu l’as quand même segmentée sur Strava.",
        "La route disparaît sous tes pieds. Elle t’avait d’abord regardée d’un air sceptique. Plus maintenant.",
    ),
    # 660 km
    (
        "⭐ LÉGENDAIRE ⭐ Architecte de l’Impossible 🏗️",
        "⭐ LÉGENDAIRE ⭐ Architecte de l’Impossible 🏗️",
        "Tu construis l’impossible un km à la fois. Et tu factures en données GPS.",
        "Tu construis l’impossible un km à la fois. Sans que personne ne t’ait dit que tu en étais capable. T’en avais pas besoin.",
    ),
    # 680 km
    (
        "⭐ LÉGENDAIRE ⭐ Voyageur Interstellaire 🛸",
        "⭐ LÉGENDAIRE ⭐ Voyageuse Interstellaire 🛸",
    ...
    (
        ...
        "⭐ LÉGENDAIRE ⭐ Wonder Woman du Running 🥋",
        "Chuck Norris court derrière TOI. Il prend des notes. Et un peu la honte.",
        "Wonder Woman court derrière TOI. Elle dit rien. Elle prend des notes pour sa prochaine retraite spirituelle.",
    ),
    # 740 km
    (
    ...
    (
        ...
        "Le sol tremble même les jours où tu ne cours pas. Il se souvient. Il respecte. Il ne fait pas de commentaires.",
    ),
    # 780 km
    (
        "⭐ LÉGENDAIRE ⭐ Aimant Gravitationnel 🧲",
        "⭐ LÉGENDAIRE ⭐ Aimant Gravitationnel 🧲",
        "Les km viennent à toi. Et taguent tes posts.",
        "Les km viennent à toi. Ils ont appris que tu ne les suppliais pas. Alors ils ont décidé de rester.",
    ),
    # 800 km
    (
        "⭐ LÉGENDAIRE ⭐ Dieu Vivant du Bitume 👑",
        "⭐ LÉGENDAIRE ⭐ Déesse Vivante du Bitume 👑",
    ...
    (
        ...
        "Les scientifiques veulent étudier ton métabolisme. Tu as dit ‘pas le temps’. Tu avais un entraînement.",
    ),
    # 840 km
    (
    ...
    (
        ...
        "⭐ LÉGENDAIRE ⭐ Boss Absolue 👊",
        "La discipline te demande la permission de te parler. Tu lis ses messages plus tard.",
        "La discipline te demande la permission de te parler. Tu lui as répondu que t’avais plus besoin d’elle. Tu avais intégré.",
    ),
    # 880 km
    (
        "⭐ LÉGENDAIRE ⭐ Collectionneur de Saisons 📅",
        "⭐ LÉGENDAIRE ⭐ Collectionneuse de Saisons 📅",
        "Tu ne coches plus des cases. Tu remplis des encyclopédies. Tome 3 en cours.",
        "Tu ne coches plus des cases. Tu remplis des encyclopédies. Et tu t’en fous que personne lise la préface.",
    ),
    # 900 km
    (
        "⭐ MYTHIQUE ⭐ Transcendance Totale 🔮",
        "⭐ MYTHIQUE ⭐ Transcendance Totale 🔮",
        "La science ne peut pas encore te nommer. Les linguistes travaillent. T’as des suggestions.",
        "La science ne peut pas encore te nommer. Elle pensait connaître les limites féminines. Elle avait tort.",
    ),
    # 920 km
    (
        "⭐ MYTHIQUE ⭐ Anti-Matière du Sport 🌀",
        "⭐ MYTHIQUE ⭐ Anti-Matière du Sport 🌀",
        "La flemme a déménagé, changé de planète et bloqué ton numéro.",
        "La flemme a déménagé. Elle avait vu arriver les 5h30 de réveil. Elle n’a pas attendu l’explication.",
    ),
    # 940 km
    (
        "⭐ MYTHIQUE ⭐ Monstre Incompris 🧟",
        "⭐ MYTHIQUE ⭐ Monstre Incomprise 🧟",
        "Ton entourage dit ‘mais pourquoi ?’. Tu leur expliques. Longuement. Avec stats.",
        "Ton entourage dit ‘mais pourquoi ?’. Tu réponds avec les yeux d’une femme qui n’a plus rien à prouver.",
    ),
    # 960 km
    (
        "⭐ MYTHIQUE ⭐ Mythe Vivant 🏛️",
        "⭐ MYTHIQUE ⭐ Mythe Vivante 🏛️",
    ...
    (
        ...
        "Tu es un phénomène météorologique. Classée ‘impossible’ il y a 980 km. Les prévisions étaient fausses.",
    ),
    # 1000 km
    (
        "☠️ ULTIME LÉGENDAIRE ☠️ 1000 km Accomplis ✅",
        "☠️ ULTIME LÉGENDAIRE ☠️ 1000 km Accomplis ✅",
        "Les dieux de l’Olympe ont annulé leur salle de sport par honte. Bravo. T’as screenshotté.",
        "Les déesses de l’Olympe ont annulé leur salle de sport. Puis elles t’ont demandé si tu acceptais des élèves.",
    ),
]
...
def generate_html(participants, is_fun=False):
    ...
    def render_table(rows, table_id=""):
        ...
        for idx, p in enumerate(rows, 1):
            ...
            if is_fun:
                badge_label, badge_motiv = get_fun_badge(
                    km_float(p), p.get("sexe", "M")
                )
                denivele_val = p.get("denivele", "")
                denivele_comment = get_denivele_comment(denivele_val)
                denivele_html = (
